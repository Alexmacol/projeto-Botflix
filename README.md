...
> ⚠️ **ATENÇÃO:** Este projeto depende de um ambiente n8n ativo (pago) para funcionar completamente. Sem um workflow n8n configurado e em execução, as buscas não serão processadas.
...
- Chave de API do [TMDB - The Movie Database](https://www.themoviedb.org/)
